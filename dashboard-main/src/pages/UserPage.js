...
const TABLE_HEAD = [
  ...
  { id: 'ipDevice', label: 'IP Address', alignRight: false },
...
export default function UserPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Perangkat | ALERT SYSTEM </title>
      </Helmet>
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, role, status, area, avatarUrl, ipDevice } = row;
                    ...
                    return (
                      <TableRow hover key={id}>
                        ...
                        <TableCell align="left">{ipDevice}</TableCell>
